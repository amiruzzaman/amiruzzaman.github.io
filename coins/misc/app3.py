...
REPLACE_FOLDER = 'static/uploads'

#REPLACE_FOLDER = 'uploads'

app.config['REPLACE_FOLDER'] = REPLACE_FOLDER

# Ensure upload directory exists
os.makedirs(REPLACE_FOLDER, exist_ok=True)
...
def upload_replace():
    ...
    if file and slot in images:
        ...
        filepath = os.path.join(app.config['REPLACE_FOLDER'], filename)
        file.save(filepath)
