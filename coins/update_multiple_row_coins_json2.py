...
<div class="vault-container">
    ...
    <div class="instruction-card">
        ...
        <div class="note-warning">
            ...
            <span>⚠️ Changes are not saved automatically. Always click <strong>Save</strong> after updates.</span>
        </div>
    </div>
    ...
    <div class="toolbar">
        ...
        <div class="bulk-panel">
            ...
            <button id="bulkApplyBtn">Apply Bulk</button>
        </div>
        <button id="saveBtn" class="save-btn">Save to File</button>
