...
// Save item function - FIXED to use ID instead of index
# function saveItem(index) {
#     console.log("=== SAVE ITEM CALLED ===");
#     console.log("Index parameter:", index);
    
#     const item = collectionData[index];
#     console.log("Original item from collectionData:", item);
    
#     if (!item) {
#         console.error("Item not found in collectionData at index:", index);
...
#     if (!itemElement) {
#         console.error("Could not find item element for index:", index);
#         showToast('Error: Could not find item to edit', 'error');
#         return;
#     }
    
#     // Get updated values - CRITICAL: include the id
#     const updatedItem = {
#         id: item.id,   // Use the actual ID from the original item
...
#     console.log("Updated item data being sent:", updatedItem);
...
#     if (!updatedItem.id) {
#         console.error("Item missing ID. Full item data:", item);
#         showToast('Error: Item missing ID. Please refresh and try again.', 'error');
#         return;
#     }
    
#     // Send update to server with detailed error handling
#     fetch('/test', {
#         method: 'POST',
#         headers: {
