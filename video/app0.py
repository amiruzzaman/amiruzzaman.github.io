...
def edit_video():
    ...
    try:
        ...
        for idx, (start, end) in enumerate(keep_segments):
            ...
            with progress_lock:
                progress_percentage = int((idx + 1) / total_segments * 50)  # First 50% for extraction
        ...
        try:
            ...
            # Write the final video without unsupported parameters
            with progress_lock:
                progress_percentage = 70
            
            # Write video file - remove verbose parameter
            final_clip.write_videofile(
                output_path,
                codec='libx264',
                audio_codec='aac',
                logger=None  # Only use logger parameter
            )
